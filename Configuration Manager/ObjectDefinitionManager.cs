...
namespace Configuration_Manager
{
    class ObjectDefinitionManager
    {
        ...
        private void ReadControls(XDocument xdoc)
        {
        ...
        private void CreatePreviewControls(Section s, XElement i)
        {
            switch (i.Attribute("type").Value)
            {
                ...
                case "CTabPage":
                    ...
                    //ctp.cd.Name = i.Descendants("Name").FirstOrDefault().Value;
                    break;
            }
        }
        ...
        private void SetRealParent(ICustomControl c, XContainer i)
        {
            ...
            else
            {
                ...
                //c.cd.Parent = Model.getInstance().AllControls.Find(p => p.cd.Name == definedParent) as Control;
            }
        }
