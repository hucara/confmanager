...
{
    class CoupledControlsManager
    {
        public CoupledControlsManager()
        {
        }
        ...
        public void ComboBoxCoupled(object sender, EventArgs e)
        {
        ...
        public void CheckBoxCoupled(object sender, EventArgs e)
        {
